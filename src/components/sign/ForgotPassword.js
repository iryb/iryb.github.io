...
import forgotImage from '@assets/images/forgot-password.jpg';
      ...
      <Col md={9} className={clsx(styles.cardContainer, styles.sign)}>
        <Card className={clsx(styles.card, "border-0 shadow-lg my-5")}>
          <Card.Body className="p-0">
            <Row>
              <Col lg={6} className={clsx(styles.loginImage, "d-none d-lg-block")} style={{ backgroundImage: `url(${forgotImage})` }}>
              </Col>
              <Col lg={6} className={clsx(styles.formColumn, "p-5")}>
                ...
                <div className="w-100 text-center mt-3">
                  <p className="mb-0"><Link to="/signup">Create an Account!</Link></p>
